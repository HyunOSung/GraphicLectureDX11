...
bool Engine::InitializeScene()
{
	...
	LPCTSTR barbarousTexture = TEXT("Resources/Textures/T_Barbarous_D.TGA");
	LPCTSTR barbarousTexture = TEXT("Resources/Textures/T_Barbarous_N.TGA");
	...
	tppWarp->AddTexture(tppNormaTexture);
