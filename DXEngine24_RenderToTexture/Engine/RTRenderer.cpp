	...
	int bitmapWidth, int bitmapHeight)
{
	...
	result = device->CreateInputLayout(
		...
		vertexShaderBuufer->GetBufferPointer(),
		vertexShaderBuufer->GetBufferSize(),
		&inputLayout
	);
...
void RTRenderer::UpdateBuffers(ID3D11DeviceContext * deviceContext, int positionX, int positionY)
{
	...
	deviceContext->UpdateSubresource(vertexBuffer, 0, 0, &vertices, 0, 0);
}
